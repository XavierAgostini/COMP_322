...
int main() {
	...
	//test question 1
	ContinuedFraction test1;
//	test1.fixedPart={1,2,3};
	test1.fixedPart ={};
	test1.periodicPart={2,4,8};
	cout<<"Question #1: ";
	auto dummy = fractionalPart(test1);
	printCF(dummy,10);


	//test question2
	cout << "Question 2: " << spitSqrt8(1)<< endl;

	// test Euler square
	cout << "Question 3: Test Case: " << spitEulerSquare(NULL)<<endl;
	//e^2 = [7; 2,1,1,3,18, 5,1,1,6,30 ,8,1,1,9,42 ,11,1,1,12,54, 14...]
    cout << "Integers in the sequence of e^2: " << endl;
	for (unsigned int ada = 0; ada < 28; ++ada) {
    ...
    ContinuedFraction sqrt2red;
    sqrt2red.fixedPart = {1};
    sqrt2red.periodicPart = {2};
